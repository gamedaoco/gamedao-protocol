...
export class Organization extends Entity {
  ...
  set feeModel(value: BigInt) {
    this.set("feeModel", Value.fromBigInt(value));
  }
  ...
  set activeMembers(value: BigInt) {
    this.set("activeMembers", Value.fromBigInt(value));
  }
...
export class Member extends Entity {
  ...
  get proposalsCount(): BigInt {
    let value = this.get("proposalsCount");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set proposalsCount(value: BigInt) {
    this.set("proposalsCount", Value.fromBigInt(value));
  }

  get votesCount(): BigInt {
    let value = this.get("votesCount");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set votesCount(value: BigInt) {
    this.set("votesCount", Value.fromBigInt(value));
  }
...
export class Treasury extends Entity {
  ...
  set dailyLimit(value: BigDecimal) {
    this.set("dailyLimit", Value.fromBigDecimal(value));
  }

  get lastSpendingReset(): BigInt {
    let value = this.get("lastSpendingReset");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set lastSpendingReset(value: BigInt) {
    this.set("lastSpendingReset", Value.fromBigInt(value));
  }

  get todaySpent(): BigDecimal {
    let value = this.get("todaySpent");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigDecimal();
  ...
  set todaySpent(value: BigDecimal) {
    this.set("todaySpent", Value.fromBigDecimal(value));
  }
...
export class Profile extends Entity {
  ...
  get reputationImports(): ReputationImportLoader {
    return new ReputationImportLoader(
      "Profile",
      this.get("id")!.toString(),
      "reputationImports"
    );
...
export class ReputationImport extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ReputationImport entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ReputationImport must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("ReputationImport", id.toString(), this);
    }
  }

  static loadInBlock(id: string): ReputationImport | null {
    return changetype<ReputationImport | null>(
      store.get_in_block("ReputationImport", id)
    );
  }

  static load(id: string): ReputationImport | null {
    return changetype<ReputationImport | null>(
      store.get("ReputationImport", id)
    );
  }
  ...
  get sourceProfile(): Bytes {
    let value = this.get("sourceProfile");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set sourceProfile(value: Bytes) {
    this.set("sourceProfile", Value.fromBytes(value));
  }

  get importedExperience(): BigInt {
    let value = this.get("importedExperience");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set importedExperience(value: BigInt) {
    this.set("importedExperience", Value.fromBigInt(value));
  }

  get importedReputation(): BigInt {
    let value = this.get("importedReputation");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set importedReputation(value: BigInt) {
    this.set("importedReputation", Value.fromBigInt(value));
  }

  get importedTrust(): BigInt {
    let value = this.get("importedTrust");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set importedTrust(value: BigInt) {
    this.set("importedTrust", Value.fromBigInt(value));
  }
...
export class ReputationImportLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): ReputationImport[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<ReputationImport[]>(value);
  }
}
