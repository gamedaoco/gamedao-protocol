...
export class Registry__getModuleInfoResultValue0Struct extends ethereum.Tuple {
  get moduleAddress(): Address {
...
export class Registry extends ethereum.SmartContract {
  ...
  getModuleInfo(moduleId: Bytes): Registry__getModuleInfoResultValue0Struct {
    let result = super.call(
      "getModuleInfo",
    ...
    return changetype<Registry__getModuleInfoResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getModuleInfo(
    moduleId: Bytes
  ): ethereum.CallResult<Registry__getModuleInfoResultValue0Struct> {
    let result = super.tryCall(
      "getModuleInfo",
      "getModuleInfo(bytes32):((address,string,bool,uint256,uint256))",
      [ethereum.Value.fromFixedBytes(moduleId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<Registry__getModuleInfoResultValue0Struct>(value[0].toTuple())
    );
  }
