...
export class Staking__getOrganizationStakeResultValue0Struct extends ethereum.Tuple {
  get organizationId(): Bytes {
...
export class Staking__getPoolInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class Staking__organizationStakesResult {
  value0: Bytes;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class Staking__stakingPoolsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Staking__unstakeRequestsResult {
  value0: BigInt;
  value1: BigInt;
  value2: i32;
  value3: boolean;
...
export class Staking__userStakesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Staking extends ethereum.SmartContract {
  ...
  getOrganizationStake(
    organizationId: Bytes
  ): Staking__getOrganizationStakeResultValue0Struct {
    let result = super.call(
      "getOrganizationStake",
    ...
    return changetype<Staking__getOrganizationStakeResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getOrganizationStake(
    organizationId: Bytes
  ): ethereum.CallResult<Staking__getOrganizationStakeResultValue0Struct> {
    let result = super.tryCall(
      "getOrganizationStake",
      "getOrganizationStake(bytes8):((bytes8,address,uint256,uint256,bool))",
      [ethereum.Value.fromFixedBytes(organizationId)]
    ...
    return ethereum.CallResult.fromValue(
      changetype<Staking__getOrganizationStakeResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getPoolInfo(purpose: i32): Staking__getPoolInfoResult {
    let result = super.call(
      "getPoolInfo",
    ...
    return new Staking__getPoolInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_getPoolInfo(
    purpose: i32
  ): ethereum.CallResult<Staking__getPoolInfoResult> {
    let result = super.tryCall(
      "getPoolInfo",
      "getPoolInfo(uint8):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(purpose))]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Staking__getPoolInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  getStakeInfo(user: Address, purpose: i32): Staking__getStakeInfoResult {
    let result = super.call(
      "getStakeInfo",
  ...
  organizationStakes(param0: Bytes): Staking__organizationStakesResult {
    let result = super.call(
      "organizationStakes",
    ...
    return new Staking__organizationStakesResult(
      result[0].toBytes(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_organizationStakes(
    param0: Bytes
  ): ethereum.CallResult<Staking__organizationStakesResult> {
    let result = super.tryCall(
      "organizationStakes",
      "organizationStakes(bytes8):(bytes8,address,uint256,uint256,bool)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Staking__organizationStakesResult(
        value[0].toBytes(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  stakingPools(param0: i32): Staking__stakingPoolsResult {
    let result = super.call(
      "stakingPools",
    ...
    return new Staking__stakingPoolsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_stakingPools(
    param0: i32
  ): ethereum.CallResult<Staking__stakingPoolsResult> {
    let result = super.tryCall(
      "stakingPools",
      "stakingPools(uint8):(uint256,uint256,uint256,uint256,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param0))]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Staking__stakingPoolsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  unstakeRequests(
    param0: Address,
    param1: BigInt
  ): Staking__unstakeRequestsResult {
    let result = super.call(
      "unstakeRequests",
    ...
    return new Staking__unstakeRequestsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBoolean()
  ...
  try_unstakeRequests(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Staking__unstakeRequestsResult> {
    let result = super.tryCall(
      "unstakeRequests",
      "unstakeRequests(address,uint256):(uint256,uint256,uint8,bool)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Staking__unstakeRequestsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBoolean()
  ...
  userStakes(param0: Address, param1: i32): Staking__userStakesResult {
    let result = super.call(
      "userStakes",
    ...
    return new Staking__userStakesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_userStakes(
    param0: Address,
    param1: i32
  ): ethereum.CallResult<Staking__userStakesResult> {
    let result = super.tryCall(
      "userStakes",
      "userStakes(address,uint8):(uint256,uint256,uint256,uint256,uint256,uint8)",
      [
