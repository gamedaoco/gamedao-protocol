...
import type {
  ISignal,
  ISignalInterface,
} from "../../../contracts/interfaces/ISignal";
...
export class ISignal__factory {
  ...
  static createInterface(): ISignalInterface {
    return new Interface(_abi) as ISignalInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ISignal {
    return new Contract(address, _abi, runner) as unknown as ISignal;
  }
}
