...
import { ArrowRight, Users, DollarSign, Vote, Zap, Target, Coins, Shield, Trophy, Gamepad2, TrendingUp, Activity, Rocket, Globe, Building, Sparkles, ChevronRight, Star } from 'lucide-react'
...
export default function HomePage() {
  ...
  return (
    <div className="space-y-20">
      ...
      {/* Platform Stats - Powering the Gaming Revolution */}
      <div className="space-y-8">
        <div className="text-center space-y-4">
