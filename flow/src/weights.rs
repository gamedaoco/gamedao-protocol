...
pub trait WeightInfo {
	...
	fn on_initialize(b: u32, c: u32, ) -> Weight;
}
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_campaign(_b: u32, ) -> Weight {
		(92_468_000 as Weight)
	...
	// Storage: Flow CampaignsByState (r:3 w:2)
	// Storage: Flow Campaigns (r:3 w:0)
	// Storage: Flow CampaignBalance (r:3 w:0)
	// Storage: Flow CampaignOrg (r:3 w:0)
	// Storage: Control OrgTreasury (r:1 w:0)
	// Storage: Flow CampaignContributors (r:3 w:0)
	// Storage: Flow ContributorsReverted (r:3 w:3)
	// Storage: Tokens Accounts (r:1 w:1)
	// Storage: Flow CampaignState (r:3 w:3)
	// Storage: Flow CampaignOwner (r:3 w:0)
	// Storage: Flow ContributorsFinalized (r:3 w:3)
	// Storage: Flow CampaignContribution (r:3 w:0)
	// Storage: System Account (r:1 w:1)
	fn on_initialize(b: u32, c: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 579_000
			.saturating_add((11_769_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 5_383_000
			.saturating_add((120_226_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(b as Weight)))
			.saturating_add(T::DbWeight::get().reads((19 as Weight).saturating_mul(c as Weight)))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(b as Weight)))
			.saturating_add(T::DbWeight::get().writes((7 as Weight).saturating_mul(c as Weight)))
	}
}
...
impl WeightInfo for () {
	...
	fn on_initialize(b: u32, c: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add(RocksDbWeight::get().reads((19 as Weight).saturating_mul(c as Weight)))
			.saturating_add(RocksDbWeight::get().writes((1 as Weight).saturating_mul(b as Weight)))
			.saturating_add(RocksDbWeight::get().writes((7 as Weight).saturating_mul(c as Weight)))
	}
}
