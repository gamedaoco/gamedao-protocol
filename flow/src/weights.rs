...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_campaign() -> Weight {
		...
		Weight::from_parts(58_000_000, 14069)
	...
	fn contribute() -> Weight {
		...
		Weight::from_parts(51_000_000, 15700)
			.saturating_add(T::DbWeight::get().reads(6_u64))
	...
	fn on_initialize(c: u32, p: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `1615 + c * (288 ±0) + p * (87 ±0)`
		//  Estimated: `655398 + c * (5182 ±0) + p * (2558 ±12)`
		// Minimum execution time: 136_000 nanoseconds.
		Weight::from_parts(62_296_021, 655398)
			// Standard Error: 59_341
			.saturating_add(Weight::from_ref_time(25_969_615).saturating_mul(c.into()))
			// Standard Error: 593_322
			.saturating_add(Weight::from_ref_time(10_250_535).saturating_mul(p.into()))
			...
			.saturating_add(Weight::from_proof_size(5182).saturating_mul(c.into()))
			.saturating_add(Weight::from_proof_size(2558).saturating_mul(p.into()))
	}
}
